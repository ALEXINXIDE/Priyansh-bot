...
module.exports.run =  ({ api, event, args, client, Users, Threads, __GLOBAL, Currencies }) => {
  ...
  {body:`» Owner of ${global.config.BOTNAME} 𑁍͢𝐙④𝐈𝐍᭄ «\n➟ ${global.config.BOTOWNER}\n⩙ Age:19 ${global.config.AGE}\n⩸Gender:Male ${global.config.GENDER}\n❂ Admin UID:100062376212322 ${global.config.ADMINBOT}\n♛ Admin FB 100062376212322 Link:\n https://www.facebook.com/profile.php?id=100062376212322${global.config.OWNERLINK}`, attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
